...
samples = Channel.fromPath("${params.vcf}/*")
    println """\
     ...
     G E N O M I C --------------- M E D I C I N E 
      ...
      CADD_score(chrx)
      VEP_score(CADD_score.out.pre_proc_1.collect(),params.homos_vep,params.vep_plugins,params.plugin1,params.plugin2,params.genomad_indx1,params.genomad_indx2)

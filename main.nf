...
//    .view { "CADD Subfolders: ${it.join(', ')}" }
    ...
    println """\
     ...
     G E N O M I C --------------- M E D I C I N E 
      ...
      Pre_processing_2(Pre_processing_1.out.collect(),params.header_meta,params.IBD_gwas_bed,params.Genecode_p50_bed,params.templates)
      Pre_processing_3(Pre_processing_2.out.main.collect(),params.templates)     

process CADD_score {
  ...
  //maxForks 10
  input:
  tuple val(chrx), val(vcf_n), file(vcfFile), path(cadd_param) 
  ...
  script:
    """
    ln -s ${cadd_param} /opt/CADD-scripts-CADD1.6/data/annotations/
    tree /opt/CADD-scripts-CADD1.6/data/annotations/
   ## ls ${cadd_param}
